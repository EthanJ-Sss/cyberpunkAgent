...
"""
部署 2.26讨论.html 到服务器
使用方法: python deploy_discussion.py
"""
import paramiko
import os
import sys
...
REMOTE_PATH = "/var/www/cyberagent-discussion"
LOCAL_FILE = "2.26讨论.html"
WEB_PORT = 4185  # 选择空闲端口 4185
SERVICE_NAME = "cyberagent-discussion"
# ============================================================

def main():
    print("=" * 50)
    print("  Deploy 2.26讨论.html")
    print("=" * 50)
    print(f"\nServer: {SERVER}")
