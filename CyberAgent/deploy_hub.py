...
# -*- coding: utf-8 -*-
"""
部署文档中心页 (index_hub.html) 到服务器
使用方法: python deploy_hub.py
"""
import paramiko
import os
import sys
...
REMOTE_PATH = "/var/www/cyberagent-hub"
LOCAL_FILE = "index_hub.html"
WEB_PORT = 4180  # 文档中心使用 4180 端口
SERVICE_NAME = "cyberagent-hub"
# ============================================================

def main():
    print("=" * 50)
    print("  Deploy CyberAgent Documentation Hub")
    print("=" * 50)
    print(f"\nServer: {SERVER}")
